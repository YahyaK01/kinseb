...
const ServiceCTA = () => {
  ...
  const containerStyle = {
    ...
    overflow: 'hidden',
    background: 'linear-gradient(0deg, rgba(4, 9, 29, 0.08) 62.29%, rgba(4, 9, 29, 0.4) 100%), linear-gradient(0deg, rgba(0, 0, 0, 0.6) -15.43%, rgba(0, 0, 0, 0) 123.66%), url(/images/131.jpg)',
