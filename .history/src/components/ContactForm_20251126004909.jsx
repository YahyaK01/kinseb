...
export default function LandingPage() {
  ...
  // Static content - Updated email
  const content = {
    shortTitle: "Transform Your Goals",
    title: "FInto Real Business Growth",
    description: "You bring the vision, we’ll bring the strategy. Let’s turn ambitious ideas into unstoppable results.",
