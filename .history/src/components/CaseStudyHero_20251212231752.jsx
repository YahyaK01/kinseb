      ...
      >
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
            fontSize: windowWidth <= 768 ? '24px' : windowWidth <= 1024 ? '38px' : '52px',
            lineHeight: windowWidth <= 768 ? '32px' : windowWidth <= 1024 ? '48px' : '65px',
            textAlign: 'center',
          ...
          {/* Third Line - Gradient Text */}
          <h2 style={{
            width: '100%',
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
            fontSize: windowWidth <= 768 ? '28px' : windowWidth <= 1024 ? '42px' : '58px',
            lineHeight: windowWidth <= 768 ? '36px' : windowWidth <= 1024 ? '52px' : '68px',
            textAlign: 'center',
            textTransform: 'uppercase',
