  ...
  useEffect(() => {
    ...
    const handleWheel = (e) => {
      ...
      if (isInView) {
        ...
        // Check if we should lock vertical scroll
        if (e.deltaY > 0 && currentScroll < maxScroll) {
          // Scrolling down and haven't reached end of horizontal scroll
          e.preventDefault();
          scrollContainer.scrollLeft += e.deltaY;
          setIsScrollLocked(true);
        } else if (e.deltaY < 0 && currentScroll > 0) {
          // Scrolling up and haven't reached start of horizontal scroll
          e.preventDefault();
          scrollContainer.scrollLeft += e.deltaY;
          setIsScrollLocked(true);
        } else {
  ...
  return (
    <>
      ...
      <div ref={containerRef} style={desktopContainerStyle}>
        {/* Left Side - Sticky */}
        <div style={desktopLeftSideStyle}>
          <h1 style={{
            fontFamily: 'Inter, sans-serif',
            fontWeight: 700,
            fontSize: '36px',
