...
const ServiceCTA = () => {
  // Hardcoded content
  const content = {
    title: "Transform Your Business with Strategic Digital Solutions",
    description: "Let's turn your goals into measurable results. From strategy to execution, we'll guide you at every step with data-driven campaigns tailored to your business, budget, and audience.",
        ...
        <div className="dm-hero-card">
          <div className="dm-hero-content">
            <h1 className="dm-hero-title">
              {content.title.includes('Grow Your Brand') ? (
                <>
                  {content.title.split('Grow Your Brand')[0]}
                  <span className="dm-hero-highlight">Grow Your Brand</span>
                  {content.title.split('Grow Your Brand')[1] || ''}
                </>
              ) : (
                content.title
              )}
