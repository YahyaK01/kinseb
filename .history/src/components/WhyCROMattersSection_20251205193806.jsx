...
const WhyCROMattersSection = () => {
  ...
  // Plus sign separator container
  const plusSeparatorContainerStyle = {
    position: 'relative',
    width: '100%',
    maxWidth: '1152px',
    height: '80px',
  ...
  const horizontalLineStyle = {
    ...
    height: '2px',
    background: 'linear-gradient(90deg, transparent 0%, #848586 20%, #0D98BA 50%, #848586 80%, transparent 100%)',
    borderRadius: '10px',
  ...
  const verticalLineStyle = {
    ...
    background: 'linear-gradient(180deg, transparent 0%, #848586 20%, #0D98BA 50%, #848586 80%, transparent 100%)',
    borderRadius: '10px',
    transition: 'height 1s cubic-bezier(0.4, 0, 0.2, 1) 0.5s',
    top: '50%',
  ...
  const glowEffectStyle = {
    ...
    width: '20px',
    height: '20px',
    background: 'radial-gradient(circle, rgba(13, 152, 186, 0.6) 0%, transparent 70%)',
    borderRadius: '50%',
    opacity: isVisible ? 1 : 0,
  ...
  const verticalSeparatorStyle = {
    ...
    left: 'calc(50% - 1px)',
    top: '0',
    background: 'linear-gradient(180deg, #0D98BA 0%, #848586 50%, #0D98BA 100%)',
    borderRadius: '10px',
  ...
  return (
    <div ref={sectionRef} style={containerStyle}>
      ...
      {/* Plus Sign Separator */}
      <div style={plusSeparatorContainerStyle}>
