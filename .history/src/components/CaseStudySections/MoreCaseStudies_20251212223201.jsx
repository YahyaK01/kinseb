        ...
        <div style={{
          ...
          <div style={{
            ...
            <div 
              ...
              onMouseEnter={(e) => {
                ...
                paths.forEach(path => path.style.stroke = '#000000');
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = '#03101D';
                const paths = e.currentTarget.querySelectorAll('path');
                paths.forEach(path => path.style.stroke = '#B2AFAF');
              }}
            >
              {/* Frame 1160445468 - Left Arrows */}
              <div style={{
                width: '33px',
                height: '20px',
                position: 'relative'
              }}>
                <svg width="33" height="20" viewBox="0 0 33 20" fill="none" style={{ position: 'absolute', left: 0, top: 0 }}>
                  {/* First Arrow */}
                  <path d="M10 1L2 10L10 19" stroke="#B2AFAF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                  {/* Second Arrow */}
                  <path d="M23 1L15 10L23 19" stroke="#B2AFAF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            </div>
            ...
            <div 
              ...
              style={{
                ...
                width: '50px',
                height: '50px',
                right: windowWidth <= 768 ? '10px' : '0.5px',
                top: '0px',
                background: '#03101D',
                borderRadius: '50px',
                cursor: 'pointer',
            ...
            >
              ...
              <div style={{
                ...
                <svg width="33" height="20" viewBox="0 0 33 20" fill="none" style={{ position: 'absolute', left: 0, top: 0 }}>
                  {/* First Arrow */}
                  <path d="M10 1L18 10L10 19" stroke="#B2AFAF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                  {/* Second Arrow */}
                  <path d="M23 1L31 10L23 19" stroke="#B2AFAF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            </div>
          </div>
          ...
          <Link
            ...
            style={{
              ...
              padding: '10px 24px',
              gap: '10px',
              width: windowWidth <= 768 ? 'calc(100% - 40px)' : '250px',
              maxWidth: '250px',
              height: '48px',
              background: '#0D98BA',
              ...
              transition: 'all 0.3s ease',
              cursor: 'pointer',
              marginTop: windowWidth <= 768 ? '20px' : '0px'
            }}
            onMouseEnter={(e) => {
