  ...
  return (
    <div 
      ...
      style={{
        ...
        padding: windowWidth <= 768 ? '80px 20px' : windowWidth <= 1024 ? '100px 40px' : '120px 102px',
        gap: '30px',
        width: '100%',
        background: '#0a1628',
    ...
    >
      ...
      <div style={{
        ...
        flexDirection: 'column',
        alignItems: 'flex-start',
        padding: windowWidth <= 768 ? '30px 20px' : windowWidth <= 1024 ? '35px 30px' : '40px 40px',
        gap: '30px',
        width: '100%',
        maxWidth: '1234px',
        background: '#0B1A2E',
        ...
        {/* Quote Icon */}
        <div style={{
          fontSize: windowWidth <= 768 ? '60px' : '80px',
          color: '#3AA1DE',
          lineHeight: '1',
        ...
        <p style={{
          ...
          fontWeight: 400,
          fontSize: windowWidth <= 768 ? '15px' : windowWidth <= 1024 ? '16px' : '18px',
          lineHeight: windowWidth <= 768 ? '26px' : '32px',
          color: '#FFFFFF',
          margin: 0,
          width: '100%'
        }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Fallback company name if logo doesn't load */}
            <span style={{
              fontFamily: "'Poppins', sans-serif",
              fontWeight: 600,
