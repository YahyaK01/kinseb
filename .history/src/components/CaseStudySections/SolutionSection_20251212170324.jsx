        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              filter: isMobile || isTablet ? 'drop-shadow(0px 12px 8px rgba(125, 125, 125, 0.4))' : 'drop-shadow(-4px 15px 4px #7D7D7D)'
            }}>
              <img 
            ...
            <div style={{
              ...
              filter: isMobile || isTablet 
                ? 'drop-shadow(0px 16px 16px rgba(0, 0, 0, 0.5)) drop-shadow(0px 12px 8px #0D98BA)' 
                : 'drop-shadow(-52px 90px 112px rgba(0, 0, 0, 0.7)) drop-shadow(4px 15px 4px #0D98BA)'
            }}>
              <img 
