...
const TrustedBrands = () => {
  ...
  const brands = [
    { name: 'Brand 1', logo: '/images/marqueelogo1.png' },
    { name: 'Brand 2', logo: '/images/marqueelogo2.png' },
    { name: 'Brand 3', logo: '/images/marqueelogo3.png' },
    { name: 'Brand 4', logo: '/images/marqueelogo4.png' },
    { name: 'Brand 5', logo: '/images/marqueelogo5.png' },
  ];
