...
const StickySplitLayout = ({ servicePath = '/services/seo' }) => {
  ...
  // New: Vertical scroll to horizontal scroll effect for desktop
  useEffect(() => {
    if (isMobile) return;
  ...
  const desktopContainerStyle = {
    ...
    width: '100%',
    position: 'relative',
    minHeight: '500vh', // Increased for scroll space
  ...
  // Desktop version with vertical-to-horizontal scroll
  return (
    <>
      <style>
        {`
