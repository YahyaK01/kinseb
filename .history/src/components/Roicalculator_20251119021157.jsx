...
Your results are an estimate based on industry averages and tested conversion growth benchmarks.
  ...
  return (
    <div style={styles.wrapper} ref={sectionRef}>
      <div style={{
        ...styles.container,
        padding: isMobile ? '60px 20px' : '40px 100px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              padding: isMobile ? '30px 20px' : '30px 35px',
            ...
            <div style={{
              ...styles.ctaCard,
              flexDirection: isMobile ? 'column' : 'row',
              padding: isMobile ? '25px 20px' : '20px 35px',
