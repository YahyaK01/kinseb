  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main Title - Exactly 2 Lines with Same Font Size */}
        <div style={{
          width: '100%',
          display: 'flex',
          flexDirection: 'column',
          ...
          <h1 style={{
            ...
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
            fontSize: windowWidth <= 768 ? '28px' : windowWidth <= 1024 ? '45px' : '55px',
            lineHeight: windowWidth <= 768 ? '36px' : windowWidth <= 1024 ? '55px' : '68px',
            textAlign: 'center',
          ...
          {/* Line 2 - Gradient Text (Same Size as Line 1) */}
          <h2 style={{
            width: '100%',
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
