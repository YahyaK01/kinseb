      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              position: 'absolute',
              width: windowWidth <= 768 ? '80%' : '1225px',
              height: '4px',
              background: '#0D98BA',
              borderRadius: '2px'
            }} />
            ...
            >
              <svg width="33" height="20" viewBox="0 0 33 20" fill="none">
                <path d="M10 1L2 10L10 19" stroke="#B2AFAF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M2 10H33" stroke="#B2AFAF" strokeWidth="3" strokeLinecap="round"/>
              </svg>
            </div>
            ...
            >
              <svg width="33" height="20" viewBox="0 0 33 20" fill="none">
                <path d="M23 1L31 10L23 19" stroke="#B2AFAF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M0 10H31" stroke="#B2AFAF" strokeWidth="3" strokeLinecap="round"/>
              </svg>
            </div>
          </div>
