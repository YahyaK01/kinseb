    ...
    <>
      <style>{`
        ...
        * {
        ...
        .kinseb-form-container::-webkit-scrollbar {
          width: 6px;
        }

        .kinseb-form-container::-webkit-scrollbar-track {
          background: rgba(255, 255, 255, 0.1);
          border-radius: 3px;
        }

        .kinseb-form-container::-webkit-scrollbar-thumb {
          background: rgba(13, 152, 186, 0.5);
          border-radius: 3px;
        }

        .kinseb-form-container::-webkit-scrollbar-thumb:hover {
        ...
        @media (max-width: 1024px) {
          ...
          .kinseb-form-container { flex: 0 0 350px; padding: 25px 30px; }
        ...
        @media (max-width: 768px) {
          ...
          .kinseb-form-container { padding: 28px; }
        }
