...
const GrowthEcosystem = () => {
  ...
  const cards = [
    {
      icon: '🎯', // Replace with your actual logo
      title: 'Kinseb CRO',
        ...
        {`
          .growth-ecosystem-section {
            ...
            background: linear-gradient(0deg, rgba(4, 9, 29, 0.9), rgba(4, 9, 29, 0.9)), 
                        url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 667"><rect fill="%2304091D" width="1440" height="667"/></svg>');
