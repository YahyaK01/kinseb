...
const CaseStudyTabs = ({ activeTab, setActiveTab }) => {
  ...
  const handleTabClick = (tabId) => {
    ...
    setTimeout(() => {
      ...
      if (contentElement) {
        const yOffset = -150; // Increased offset to account for header and tabs
  ...
  return (
    <div ref={componentRef} style={{
      ...
      position: 'sticky',
      top: windowWidth <= 768 ? '60px' : '60px', // Added top offset to push below header
      zIndex: 10,
      paddingTop: '20px' // Additional padding at top
    }}>
      {/* Tab Navigation */}
      <div style={{
        display: 'flex',
        ...
        padding: windowWidth <= 768 ? '20px 20px 0px' : '40px 40px 0px 102px',
        width: '100%',
