...
const CaseStudyHero = ({ caseStudyId }) => {
  ...
  const heroData = [
    {
      ...
      title: 'UrbanCart E-Commerce 28% Revenue Uplift',
    ...
    },
    {
      ...
      title: 'AuraBloom Co. Conversion Breakthrough',
    ...
    },
    {
      ...
      title: 'TechFlow SaaS 3x Lead Conversion',
    ...
    },
    {
      ...
      title: 'FashionHub Checkout Flow Transformation',
    ...
    },
    {
      ...
      title: 'FitLife App Engagement Revolution',
    ...
    },
    {
      ...
      title: 'DataCore Enterprise Pipeline Growth',
  ...
  // Find the current case study data
  const currentStudy = heroData.find(study => study.id === caseStudyId) || heroData[0];
