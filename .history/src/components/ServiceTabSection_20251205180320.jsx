...
const ServiceTabSection = () => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && !isVisible) {
          ...
          // Scroll to bring the entire content area into view
          setTimeout(() => {
  ...
  // Content Area Wrapper Style (wraps tabs + service content)
  const contentAreaWrapperStyle = {
    display: 'flex',
    flexDirection: 'column',
    gap: '40px', // Added gap between tabs and service content
    width: '100%',
    zIndex: 5,
  };
  ...
  const tabs = [
    ...
    { icon: '/images/101.png', text: 'A/B Testing' },
    { icon: '/images/101.png', text: 'Analytics' },
    { icon: '/images/101.png', text: 'UX Design' },
    { icon: '/images/101.png', text: 'Consulting' },
  ];
  ...
  return (
    <div ref={sectionRef} style={wrapperStyle}>
      ...
      <div style={containerStyle}>
        ...
        {/* Content Area Wrapper - This wraps both tabs and service content */}
