    ...
    <>
      <style>{`
        ...
        @media (max-width: 1600px) {
          .kinseb-form-container { flex: 0 0 463px; }
          .kinseb-main-heading { font-size: 36px; line-height: 44px; }
          .kinseb-form-heading { font-size: 32px; line-height: 48px; }
        }

        @media (max-width: 1200px) {
          .kinseb-form-container { flex: 0 0 420px; padding: 40px; }
        ...
        @media (max-width: 1024px) {
          ...
          .kinseb-form-container { flex: 0 0 400px; }
          .kinseb-main-heading { font-size: 34px; line-height: 44px; }
          .kinseb-form-heading { font-size: 30px; line-height: 44px; }
        }
