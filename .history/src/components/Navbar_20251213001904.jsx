...
const navigationLinks = [
  ...
  { href: "/about", label: "About", id: "about", icon: "/images/about.svg" },
    { href: "/case-study", label: "Case Study", id: "Case Study", icon: "/images/location.svg" },
  { href: "/contact-us", label: "Contact Us", id: "contact", icon: "/images/contact.svg" }
];
...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (currentPath === '/') {
      ...
      setActiveLink('about');
         } else if (currentPath === '/case-study') {
  ...
  <div className="dropdown-content">
    <div className="dropdown-services">
      ...
      <a href="/services/branding" className="dropdown-category">
        <span className="category-title">CRO audit</span>
        <ul className="category-items">
          <li className="category-item">
      ...
      <a href="/services/web-development" className="dropdown-category">
        <span className="category-title">eCommerce Optimization</span>
        <ul className="category-items">
          <li className="category-item">
      ...
      <a href="/services/email-marketing" className="dropdown-category">
        <span className="category-title">Lead Funnel Optimization</span>
        <ul className="category-items">
          <li className="category-item">
      ...
      <a href="/services/paid-search" className="dropdown-category">
        <span className="category-title">Landing Page Optimization</span>
        <ul className="category-items">
          <li className="category-item">
      ...
      <a href="/services/social-media" className="dropdown-category">
        ...
        <ul className="category-items">
          ...
          <div className="button-container">
            <a href="/contact-us" className="quote-button" aria-label="Request A Quote">
              Request A Quote
            </a>
