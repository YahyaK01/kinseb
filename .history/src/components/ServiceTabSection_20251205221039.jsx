...
const ServiceTabSection = () => {
  ...
  // Tab Data
  const tabs = [
    { icon: '/image/101.png', text: 'CRO Audit' },
    { icon: '/image/102.png', text: 'A/B Testing' },
    { icon: '/image/103.png', text: 'Analytics' },
    { icon: '/image/104.png', text: 'UX Design' },
    { icon: '/image/105.png', text: 'Consulting' },
  ];
