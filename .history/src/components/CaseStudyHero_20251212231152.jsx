...
const CaseStudyHero = ({ slug }) => {
  ...
  const heroData = {
    'personalization-engine-transforms-user-experience': {
      category: 'Case Study',
      titleLine1: 'PERSONALIZATION ENGINE TRANSFORMS',
      ...
      metrics: [
        { value: '+37%', label: 'CVR Increase', icon: 'images/icons/chart-icon.png' },
        { value: '+156%', label: 'Revenue Growth', icon: 'images/icons/chart-icon.png' },
        { value: '2.3x', label: 'User Engagement', icon: 'images/icons/chart-icon.png' }
      ]
    },
    'e-commerce-revenue-uplift-through-testing': {
      category: 'Case Study',
      titleLine1: 'URBANCART E-COMMERCE',
      titleLine2: '',
    ...
    'saas-lead-generation-conversion-breakthrough': {
      category: 'Case Study',
      titleLine1: 'SAAS LEAD GENERATION',
      titleLine2: '',
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          {/* Line 1 - White Text (3 words) */}
          <h1 style={{
            width: '100%',
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
            fontSize: windowWidth <= 768 ? '26px' : windowWidth <= 1024 ? '40px' : '52px',
            lineHeight: windowWidth <= 768 ? '34px' : windowWidth <= 1024 ? '50px' : '65px',
            textAlign: 'center',
          ...
          {/* Line 2 - White Text (remaining words) */}
          {data.titleLine2 && (
            <h1 style={{
              width: '100%',
              fontFamily: "'Poppins', sans-serif",
          ...
          <h2 style={{
            ...
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
            fontSize: windowWidth <= 768 ? '30px' : windowWidth <= 1024 ? '45px' : '60px',
            lineHeight: windowWidth <= 768 ? '38px' : windowWidth <= 1024 ? '55px' : '70px',
            textAlign: 'center',
            textTransform: 'uppercase',
        ...
        <div style={{
          ...
          gap: '23px',
          width: '100%',
          maxWidth: windowWidth <= 768 ? '320px' : '796px',
          justifyContent: 'center'
        }}>
