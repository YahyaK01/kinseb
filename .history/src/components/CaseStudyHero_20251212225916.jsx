      ...
      >
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 600,
            fontSize: windowWidth <= 768 ? '28px' : windowWidth <= 1024 ? '45px' : '60px',
            lineHeight: windowWidth <= 768 ? '36px' : windowWidth <= 1024 ? '55px' : '75px',
            textAlign: 'center',
          ...
          <h2 style={{
            ...
            lineHeight: windowWidth <= 768 ? '40px' : windowWidth <= 1024 ? '60px' : '80px',
            textAlign: 'center',
            textTransform: 'uppercase',
