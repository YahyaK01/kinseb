      ...
      <style>
        {`
          .founder-quote-section {
            ...
            height: 400px;
            margin: 0 auto;
            background: url('/images/founder-background.png');
      ...
      >
        ...
        <div className="quote-content-wrapper">
          <p className="quote-text">
            "We don't just chase conversions—we understand the human behavior behind them. Every experiment, every insight, and every optimization is rooted in what actually drives people to act."
          </p>
          ...
          <div className="author-info">
            ...
            <p className="author-title">Founder & CEO</p>
          </div>
        </div>
      </section>
    </>
