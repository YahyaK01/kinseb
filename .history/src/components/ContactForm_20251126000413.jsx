    ...
    <>
      <style>{`
        ...
        @media (max-width: 1200px) {
          ...
          .kinseb-landing-container { gap: 40px; }
        }

        @media (max-width: 1024px) {
          .kinseb-landing-container { padding: 25px 30px; gap: 30px; }
          .kinseb-left-content { max-width: 450px; }
          .kinseb-form-container { flex: 0 0 360px; }
        ...
        @media (max-width: 768px) {
          ...
          .kinseb-form-heading { font-size: 28px; line-height: 38px; }
        ...
        @media (max-width: 480px) {
          ...
          .kinseb-form-heading { font-size: 24px; line-height: 34px; }
